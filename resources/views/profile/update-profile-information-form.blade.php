<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="w-md-75">
            ...
            <div class="mb-3">
                <x-jet-label for="firstLetter" value="{{ __('First letter') }}" />
                <x-jet-input id="firstLetter" type="text" class="{{ $errors->has('firstLetter') ? 'is-invalid' : '' }}" wire:model.defer="state.firstLetter"
                    autocomplete="firstLetter" />
                <x-jet-input-error for="firstLetter" />
            </div>
