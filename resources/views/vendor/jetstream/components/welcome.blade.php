                        ...
                        <div class="d-flex flex-row bd-highlight mb-3">
                            ...
                            <div class="ps-3">
                                ...
                                <p class="text-muted">
                                    ...
                                    toolkit, featuring Sass variables and mixins, responsive grid system, extensive prebuilt components, and powerful JavaScript
                                    plugins.
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="card-body p-3 h-100">
                        <div class="d-flex flex-row bd-highlight mb-3">
                            ...
                            <div class="ps-3">
                                ...
                                <p class="text-muted">
                                    Authentication and registration views are included with Laravel Jetstream, as well as support for user email verification
                                    and resetting forgotten passwords. So, you're free to get started what matters most: building your application.
                                </p>
                            </div>
                        </div>
                    </div>
